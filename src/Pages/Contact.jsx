  ...
  return (
    <Container className='text-light contact' id='contact'>
            ...
            <div className='contact-box'>
                <a href='mailto: Samikshyakharel405@gmail.com' className='text-decoration-none text-light shadow-lg p-3'><BiLogoGmail size={40} color='white' /> SamikshyaKharel405@gmail.com</a>
